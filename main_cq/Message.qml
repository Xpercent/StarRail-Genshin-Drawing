    ...
    Item{
        ...
        Rectangle{
            ...
            Text {
                ...
                font.pixelSize: 33 / 540 * hM
                anchors.top: parent.top
                anchors.left: parent.left
                anchors.topMargin: 10 / 540 * hM
                anchors.leftMargin: 20 / 540 * hM
                color: "#ffffff"
            }
            Text {
                text: "设置已做更改,是否重启程序?"
